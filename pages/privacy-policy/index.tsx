          ...
          <div className={styles.policies__container__terms}>
              ...
              <p
                dangerouslySetInnerHTML={{
                  __html: t("personal_information_desc", {
                    exuus:
                      "<a href='https://exuus.com/' target='_blank'>https://exuus.com/</a>",
                    getsave:
                      "<a href='https://getsave.io/' target='_blank'>https://getsave.io/</a>",
                    saveplus:
                      "<a href='https://saveplus.io/' target='_blank'>https://saveplus.io/</a>",
                  }),
                }}
              />
              <p>{t("personal_information_desc1")}</p>
            </section>
            ...
            <section>
              ...
              <dl>
                ...
                <dd>
                  -{t("Customize and improve your experience and the Services")}
                </dd>
                <dd>
                  -
                  {t(
              ...
              <p
                dangerouslySetInnerHTML={{
                  __html: t("privacy_question_description", {
                    email:
                      "<a href='mailto:support@saveplus.io' target='_blank'>support@saveplus.io</a>",
                    email1:
                      "<a href='mailto:info@exuus.com' target='_blank'>info@exuus.com</a>",
                  }),
                }}
              />
            </section>
